...
import { setWalletAddress, setCurrentNetwork, disconnectWallet as resetWalletState } from '../store/gameState';
...
class WalletService {
  ...
  setupEventListeners() {
    ...
    window.ethereum.on('chainChanged', (chainId) => {
      ...
      // 保存当前网络到状态管理
      setCurrentNetwork(this.chainId);
      // 通知监听器网络已变更
